...
class LocalizationManager {
    ...
    async loadTranslations() {
        ...
        this.translations.en = {
            ...
            'prescriptions.scanFirst': 'Scan your first prescription to get started',
            'prescriptions.scanNow': 'Scan Now',
            'prescriptions.loadError': 'Failed to load prescriptions',
            'prescriptions.uploadSuccess': 'Prescription uploaded successfully',
            'prescriptions.uploadError': 'Failed to upload prescription',
            'prescriptions.scannerError': 'Failed to open scanner',
            'prescriptions.saveSuccess': 'Prescription saved successfully',
            'prescriptions.saveError': 'Failed to save prescription',
            'prescriptions.deleteSuccess': 'Prescription deleted successfully',
            'prescriptions.deleteError': 'Failed to delete prescription',
            'prescriptions.confirmDelete': 'Are you sure you want to delete this prescription?',
            'prescriptions.ocr.completed': 'OCR processing completed',
            'prescriptions.ocr.editingEnabled': 'Editing enabled - you can now modify the extracted text',
            'prescriptions.editing.enabled': 'Editing Enabled',
            'prescriptions.camera.unsupported': 'Camera not supported on this device',
            'prescriptions.camera.uploadOnly': 'Please use the upload option instead',
            'prescriptions.camera.permissionDenied': 'Camera permission denied',
            'prescriptions.camera.enableInstructions': 'Please enable camera access in your browser settings',
            'prescriptions.camera.tryAgain': 'Try Again',
            'prescriptions.camera.permissionGranted': 'Camera permission granted',
            'prescriptions.camera.permissionFailed': 'Failed to get camera permission',
            'prescriptions.camera.noAlternative': 'No alternative camera available',
            'prescriptions.camera.switched': 'Camera switched successfully',
            'prescriptions.camera.switchError': 'Failed to switch camera',

            // File Upload
            'fileUpload.noFile': 'No file provided',
            'fileUpload.fileTooLarge': 'File size ({size}) exceeds maximum allowed size ({maxSize})',
            'fileUpload.invalidType': 'File type {type} is not allowed. Allowed types: {allowedTypes}',
            'fileUpload.filenameTooLong': 'Filename is too long and will be shortened',
            'fileUpload.dangerousFile': 'This file type is not allowed for security reasons',
            'fileUpload.compressed': 'Image compressed from {originalSize} to {newSize} ({ratio}% reduction)',
            'fileUpload.stages.starting': 'Preparing upload...',
            'fileUpload.stages.compressing': 'Compressing image...',
            'fileUpload.stages.uploading': 'Uploading file...',
            'fileUpload.stages.processing': 'Processing file...',
            'fileUpload.stages.completed': 'Upload completed!',
